  ...
  <div class="min-h-screen pb-28 md:pb-16">
    ...
    <section class="mx-auto mt-12 max-w-6xl px-4 sm:px-6 md:mt-16">
      <div class="grid grid-cols-2 gap-3 sm:gap-4 md:grid-cols-3 lg:grid-cols-4 md:gap-5">
        ...
        >
          <div class="mb-4 flex h-12 w-12 items-center justify-center rounded-2xl bg-[hsl(var(--golden-500))] text-[hsl(var(--primary))] shadow-[0_8px_18px_-10px_rgba(253,197,0,0.9)] transition-transform duration-500 ease-out group-hover:scale-110 group-hover:bg-[hsl(var(--primary))] group-hover:text-[hsl(var(--golden-500))] sm:h-14 sm:w-14">
