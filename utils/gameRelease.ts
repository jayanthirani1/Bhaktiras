...
/**
 * The shipped launch plan: Wordle and Crossword live now, the other games
 * unlocking on the 30th, one a month.
 *
 * This is the starting point, not the authority. `data/gameReleases.ts` turns
 * it into the default release entries an admin edits in Admin -> Games -> Game
 * releases, and what is stored there is what the site actually follows.
 */
