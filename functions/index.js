...
const GAME_ACHIEVEMENTS = {
  ...
  'spelling-bee': [
    ...
    { id: 'spelling-bee-days-14', when: ({ spellingBeeDays }) => spellingBeeDays >= 14 },
    { id: 'spelling-bee-days-100', when: ({ spellingBeeDays }) => spellingBeeDays >= 100 },
    { id: 'spelling-bee-days-200', when: ({ spellingBeeDays }) => spellingBeeDays >= 200 },
    { id: 'spelling-bee-days-300', when: ({ spellingBeeDays }) => spellingBeeDays >= 300 },
    { id: 'spelling-bee-pangrams-5', when: ({ spellingBeePangrams }) => spellingBeePangrams >= 5 },
...
function applyGameStats(game, candidate, stats, today) {
  if (game === 'wordle') {
    ...
    bumpOncePerDay(stats, 'spellingBeeDays', 'spellingBeeDaysDate', today)
    if (candidate.pangram) bumpOncePerDay(stats, 'spellingBeePangrams', 'spellingBeePangramsDate', today)
