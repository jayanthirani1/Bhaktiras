...
export const DEFAULT_CONNECTIONS_PUZZLES: ConnectionsPuzzle[] = [
  {
    ...
    groups: [
      ...
      { title: 'Names of Bhagwan Swaminarayan', difficulty: 3, words: ['Ghanshyam', 'Hari', 'Nilkanth', 'Sahajanand'] }
    ]
  },
  {
    id: 'mandir-life',
    ...
    published: true,
    groups: [
      { title: 'Parts of daily puja', difficulty: 0, words: ['Cheshta', 'Dhyan', 'Mansi', 'Tilak Chandlo'] },
      ...
      { title: 'Swaminarayan scriptures', difficulty: 3, words: ['Bhaktachintamani', 'Satsangi Jeevan', 'Shikshapatri', 'Vachanamrut'] }
    ]
  },
  {
