...
/**
 * Daily 1% Club ladders drawn from the English Vachnamrut published by
...
export const VACHANAMRUT_ONE_PERCENT_PACKS: OnePercentPack[] = [
  ...
  makePack('gadhada-i-a', 'gadhada-i', 'Gadhada Pratham', 'Gadhada I · early sabhas', [
    ['Gadhada I sabhas were held in whose darbar?', ['Jeeva Khachar’s', 'Dada Khachar’s', 'Joban Pagi’s only', 'A forest ashram in Badrikashram'], 'Dada Khachar’s', 'Gadhada I – 1'],
    ...
    ['How many Vachnamruts are in Gadhada Pratham (Gadhada I)?', ['12', '18', '39', '78'], '78', 'Gadhada Pratham'],
  ...
  makePack('sarangpur-a', 'sarangpur', 'Sarangpur', 'Sarangpur · conquering the mind', [
    ['Sarangpur sabhas were held in whose darbar?', ['Dada Khachar’s', 'Jeeva Khachar’s', 'Joban Pagi’s only', 'A London hall'], 'Jeeva Khachar’s', 'Sarangpur – 1'],
    ['How many Vachnamruts are in the Sarangpur prakaran?', ['7', '12', '18', '78'], '18', 'Sarangpur'],
  ...
  makePack('loya-a', 'loya', 'Loya', 'Loya · early sabhas', [
    ['How many Vachnamruts are in the Loya prakaran?', ['7', '12', '18', '67'], '18', 'Loya'],
  ...
  makePack('gadhada-ii-a', 'gadhada-ii', 'Gadhada Madhyam', 'Gadhada II · early sabhas', [
    ['How many Vachnamruts are in Gadhada Madhyam (Gadhada II)?', ['18', '39', '67', '78'], '67', 'Gadhada Madhyam'],
  ...
  makePack('gadhada-ii-b', 'gadhada-ii', 'Gadhada Madhyam', 'Gadhada II · later sabhas', [
  ...
  makePack('vadtal', 'vadtal', 'Vadtal', 'Vadtal prakaran', [
    ...
    ['Each Vachnamrut usually begins with the date, place, Maharaj’s dress and…', ['The gathered sabha', 'A shopping list', 'A tax receipt', 'A cricket score'], 'The gathered sabha', 'Preface'],
  ...
  makePack('gadhada-iii', 'gadhada-iii', 'Gadhada Antya', 'Gadhada III (Antya)', [
    ...
    ['True knowledge of the Vachnamrut is revealed by the grace of…', ['Swaminarayan Bhagvan', 'A school examiner', 'A newspaper editor', 'A village accountant'], 'Swaminarayan Bhagvan', 'Preface'],
