...
/**
 * Shown in place of a page whose section an admin has switched off. Keeping the
 * URL rather than redirecting means an old link lands somewhere that says why
