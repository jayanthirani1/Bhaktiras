...
export const ACHIEVEMENT_DEFINITIONS: AchievementDefinition[] = [
  ...
  { id: 'spelling-bee-first-word', title: 'First Hive Word', description: 'Find your first Spelling Bee word.', group: 'spelling-bee', medal: 'bronze' },
  { id: 'spelling-bee-days-14', title: 'Hive Devotee', description: 'Play Spelling Bee on 14 different days.', group: 'spelling-bee', medal: 'silver', progress: { stat: 'spellingBeeDays', goal: 14, unit: 'days' } },
  { id: 'spelling-bee-days-100', title: '100-Day Hive', description: 'Play Spelling Bee on 100 different days.', group: 'spelling-bee', medal: 'gold', progress: { stat: 'spellingBeeDays', goal: 100, unit: 'days' } },
  { id: 'spelling-bee-days-200', title: '200-Day Hive', description: 'Play Spelling Bee on 200 different days.', group: 'spelling-bee', medal: 'gold', progress: { stat: 'spellingBeeDays', goal: 200, unit: 'days' } },
  { id: 'spelling-bee-days-300', title: '300-Day Hive', description: 'Play Spelling Bee on 300 different days.', group: 'spelling-bee', medal: 'platinum', progress: { stat: 'spellingBeeDays', goal: 300, unit: 'days' } },
  { id: 'spelling-bee-pangrams-5', title: 'Pangram Hunter', description: 'Find 5 pangrams across different days.', group: 'spelling-bee', medal: 'gold', progress: { stat: 'spellingBeePangrams', goal: 5, unit: 'pangrams' } },
  { id: 'spelling-bee-score-100', title: 'Queen Bee', description: 'Score 100 points in a single Spelling Bee hive.', group: 'spelling-bee', medal: 'platinum' },
