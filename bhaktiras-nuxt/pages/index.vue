...
const menuItems = [
  ...
  { id: 'seva', title: 'Seva', desc: 'Volunteer Roles', icon: IconHand, color: 'bg-green-100 text-green-600', href: '/seva' },
  { id: 'play', title: 'Play', desc: 'Quiz, Wordle, Spelling Bee & more', icon: IconGamepad2, color: 'bg-yellow-100 text-yellow-600', href: '/play' },
